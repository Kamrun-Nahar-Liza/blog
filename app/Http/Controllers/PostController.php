...
if(Input::hasFile('post_image')){
    ...
    public function edit($post_id){
      ...
      return view('edit' , ['categories' => $categories, 'posts' => $posts, 'category' => $category]);
    }
...
if(Input::hasFile('post_image')){
       ...
       return redirect('/home')->with('response', 'Post updateed successfully');
    }
    ...
    public function category($cat_id){
      ...
      return view('categoriesposts' , ['categories' => $categories , 'posts' => $posts]);
    }
